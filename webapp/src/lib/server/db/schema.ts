...
export const uploadProgress = pgTable(
	'upload_progress',
	{
		id: serial('id').primaryKey(),
		location: varchar('location', { length: 50 }).notNull(),
...
export const wageSummaries = pgTable(
	'wage_summaries',
	{
		id: serial('id').primaryKey(),
		location: varchar('location', { length: 50 }).notNull(),
...
export const wagePyramids = pgTable(
	'wage_pyramids',
	{
		id: serial('id').primaryKey(),
		location: varchar('location', { length: 50 }).notNull(),
...
// Job title analysis
export const titleAnalysis = pgTable(
	'title_analysis',
	{
		id: serial('id').primaryKey(),
		location: varchar('location', { length: 50 }).notNull(),
